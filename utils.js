...
/**
 * Map some common Prisma error codes to HTTP statuses/messages.
 * Avoid importing Prisma runtime internals; rely on err.code.
 */
function mapPrismaError(err) {
  ...
  switch (err.code) {
    case 'P2002': // unique constraint failed
      return { status: 409, body: { error: 'Unique constraint failed', meta: err.meta || null } };
    ...
    default:
      return { status: 400, body: { error: 'Database error', code: err.code, message: err.message } };
  }
}
